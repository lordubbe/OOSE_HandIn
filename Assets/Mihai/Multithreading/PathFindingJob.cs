...
public class PathFindingJob : ThreadedJob
{
    ...
    public event PathFinding.pathF p;
    ...
    public void SetClass(Vector3 sPos, Vector3 fPos, PathFinding.pathF completeF, float error = 0, float height = 1){
        buildNodeMap();
        p += completeF;
        objPos = sPos;
        this.height = height;
    ...
    private void populatePath()
    {
        ...
        {
            path[i] = pathList[pathList.Count - i];
        }
